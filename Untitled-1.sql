...
values(
    ...
    1,
    1
  ),("2009-09-05", "19:00:00", "Iaí Carlos", 1, 1, 1),("2009-09-10", "19:00:00", "Tudo beleza?", 1, 1, 1);
select
  *
from
  medico_tem_especialidade;
update
  Funcionario
set
  Endereco = "Casa dele ué"
where
  1 = 1
  and NomeFuncionario = "Carlos"
  and SobrenomeFuncionario = "Kuretzki";
update
  Paciente
set
  CPF = "09028824901"
where
  1 = 1
  and NomePaciente = "Flávio"
  and SobrenomePaciente = "Branco";
update
  Especialidade
set
  NomeEspecialidade = "Comer cu de quem da update sem where"
where
  1 = 1
